...
describe('<LimitReq />', () => {
	it('extends LimitConnReqConstructor', () => {
		expect(LimitReq.prototype).to.be.an.instanceOf(LimitConnReqConstructor);
	});
	...
	it('getHeadRow()', () => {
		...
		expect(headRow.children, 'cells count').to.have.lengthOf(7);
	...
	it('getBody()', () => {
		...
		expect(row.children, '[group 1, row 1] children length').to.have.lengthOf(7);
		...
		expect(row.children[3].attributes.className, '[group 1, row 1] child 4, className')
			.to.be.equal(styles['bdr']);
		expect(row.children[3].children[0], '[group 1, row 1] child 4, child').to.be.equal('55');
		expect(row.children[4].nodeName, '[group 1, row 1] child 5, nodeName').to.be.equal('td');
		expect(row.children[4].attributes.className, '[group 1, row 1] child 5, className')
			.to.be.equal(styles['bdr']);
		expect(row.children[4].children[0], '[group 1, row 1] child 5, child').to.be.equal('9');
		expect(row.children[5].nodeName, '[group 1, row 1] child 6, nodeName').to.be.equal('td');
		expect(row.children[5].attributes.className, '[group 1, row 1] child 6, className')
			.to.be.equal(styles['bdr']);
		expect(row.children[5].children[0], '[group 1, row 1] child 6, child').to.be.equal('11');
		expect(row.children[6].nodeName, '[group 1, row 1] child 7, nodeName').to.be.equal('td');
		expect(row.children[6].children[0], '[group 1, row 1] child 7, child').to.be.equal('13');
		...
		expect(row.children[0].attributes.colspan, '[group 1, row 2] child colspan').to.be.equal('7');
		expect(
		...
		expect(row.children, '[group 2, row 1] children length').to.have.lengthOf(7);
		...
		expect(row.children[3].attributes.className, '[group 2, row 1] child 4, className')
			.to.be.equal(styles['bdr']);
		expect(row.children[3].children[0], '[group 2, row 1] child 4, child').to.be.equal('5');
		expect(row.children[4].nodeName, '[group 2, row 1] child 5, nodeName').to.be.equal('td');
		expect(row.children[4].attributes.className, '[group 2, row 1] child 5, className')
			.to.be.equal(styles['bdr']);
		expect(row.children[4].children[0], '[group 2, row 1] child 5, child').to.be.equal('0');
		expect(row.children[5].nodeName, '[group 2, row 1] child 6, nodeName').to.be.equal('td');
		expect(row.children[5].attributes.className, '[group 2, row 1] child 6, className')
			.to.be.equal(styles['bdr']);
		expect(row.children[5].children[0], '[group 2, row 1] child 6, child').to.be.equal('1');
		expect(row.children[6].nodeName, '[group 2, row 1] child 7, nodeName').to.be.equal('td');
		expect(row.children[6].children[0], '[group 2, row 1] child 7, child').to.be.equal('0');
