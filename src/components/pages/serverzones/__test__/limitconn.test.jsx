...
describe('<LimitConn />', () => {
	it('extends ChartsTable', () => {
		expect(LimitConn.prototype).toBeInstanceOf(ChartsTable);
	});
	...
	it('getHeadRow()', () => {
		...
		// cells count
		expect(headRow.props.children).toHaveLength(6);
	...
	it('getBody()', () => {
		...
		expect(row.props.children).toHaveLength(6);
		...
		expect(row.props.children[3].props.children).toBe(9);
		...
		expect(row.props.children[4].props.children).toBe(13);
		// [group 1, row 1] child 6, nodeName
		expect(row.props.children[5].type).toBe('td');
		// [group 1, row 1] child 6, child
		expect(row.props.children[5].props.children).toBe(6);
		...
		expect(row.props.children[3].props.children).toBe(0);
		// [group 2, row 1] child 5, nodeName
		expect(row.props.children[4].type).toBe('td');
		// [group 2, row 1] child 5, className
		expect(row.props.children[4].props.className).toBe(styles.bdr);
		// [group 2, row 1] child 5, child
		expect(row.props.children[4].props.children).toBe(3);
		// [group 2, row 1] child 6, nodeName
		expect(row.props.children[5].type).toBe('td');
		// [group 2, row 1] child 6, child
		expect(row.props.children[5].props.children).toBe(2);
