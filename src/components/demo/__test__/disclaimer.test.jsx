...
describe('<Disclaimer /> (demo)', () => {
	...
	it('render()', () => {
		...
		expect(links.get(0).attributes.href, '1st link href').to.be.equal('http://demo.nginx.com/swagger-ui/');
		...
		expect(links.get(2).attributes.href, '3rd link href').to.be.equal('https://www.nginx.com/#contact-us');
